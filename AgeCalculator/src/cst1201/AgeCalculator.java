	...
	public static void main(String[] args) {
		//Get the current year.
         ...
         int newAge = currentAge + yearsToAdd;
          ...
          System.out.println("You will be " + newAge + "-years-old in "+ anotherYear + ".");}
         else if (newAge <0 )
        System.out.println("You weren't born ");
        else if (newAge <= 1)
        System.out.println("You were " + newAge + "-year-old in "+ anotherYear + ".");
        else if (newAge < currentAge)
        System.out.println("You were " + newAge + "-years-old in "+ anotherYear + ".");
